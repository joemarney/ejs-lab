...
app.get("/", (req, res) => {
  res.render("home.ejs", {
    ...
    openMsg: "Yes, we are open!",
    closedMsg: "Sorry, we are closed.",
  });
});
...
app.get("/menu/:category", (req, res) => {
  // filter the array down to mains, sides or desserts into a new array called menuItems
  // render the category page with either mains, sides or desserts based on the req.params
